...
Limits limits[MRMode::Area_end] =
		{	//----------ParallelLeg----------   ----------SingleLeg----------
			//{{x.max, 			x.min}, 			{y.max, y.min}, {angle.max, angle.min}, {duty.max, duty.min}}
			  ...
			  {{X_CLIMB_MAX,  	X_CLIMB_MIN}, 		{250, 	100}, 	{110, 		-20}, 		{0.75, 	   0.25}},//StartClimb1//Front開始
			  {{X_CLIMB_MAX,  	X_CLIMB_MIN}, 		{250, 	100}, 	{110, 		-20}, 		{0.75, 	   0.25}},//StartClimb2
...
Orbits orbits[MRMode::Area_end] =
		{		//gradient, 	init_x,			init_y, height
				...
				{0, 			0,				280, 	50},	//Start1
				{0, 			0,				260, 	30},	//GobiArea
				{0, 			0,				260,	140},	//SandDuneFront
				{0,				0,				260,	20},	//SandDuneRear
				...
				{0, 			0,				200, 	50},	//GetSign
				{0, 			0,				200, 	50},	//Start2
				{GRAD_SLOPE,	0, 				200, 	80},	//StartClimb1//Front開始
				{0,				X_CLIMB_INIT,	200, 	40},	//StartClimb2
